...
namespace FastFoodDemo.BL
{
    class CONFSCATION
    {
        public void ADD_NEW_CONFSCATION(string TYPE, DateTime DATE, string SOURCE, string CONTENT, string NOTES, int IS_DEL)
        {
            ...
            DAL.excutecommand("ADD_NEW_CONFSCATION", param);
            DAL.close();

        }
        public DataTable GET_ALL_CONFSCATIONS()
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable Dt = new DataTable();
            Dt = DAL.selectdata("GET_ALL_CONFSCATIONS", null);
            DAL.close();
            return Dt;
        }

        public void EDIT_CONFSCATION(string TYPE, DateTime DATE, string SOURCE, string CONTENT, string NOTES, int ID)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.open();
            SqlParameter[] param = new SqlParameter[6];
            ...
            DAL.excutecommand("EDIT_CONFSCATION", param);
            DAL.close();

        }
        public void DELETE_CONFSCATION(int ID)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.open();
            ...
            DAL.excutecommand("DELETE_CONFSCATION", param);
            DAL.close();

        }

        public DataTable SEARCH_CONFSCATION(string SEARCH)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable Dt = new DataTable();
            SqlParameter[] param = new SqlParameter[1];
            ...
            Dt = DAL.selectdata("SEARCH_CONFSCATION", param);
            DAL.close();
            return Dt;
        }
