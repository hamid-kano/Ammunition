...
namespace FastFoodDemo.BL
{
    class ORDERS
    {
        public void ADD_NEW_ORDER(string TYPE, DateTime DATE, string SOURCE, string CONTENT,  string NOTES,int IS_DEL)
        {
            ...
            DAL.excutecommand("ADD_NEW_ORDER", param);
            DAL.close();
        ...
        public void EDIT_ORDER(string TYPE, DateTime DATE, string SOURCE, string CONTENT, string NOTES, int ID)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DAL.open();
            SqlParameter[] param = new SqlParameter[6];
            ...
            DAL.excutecommand("EDIT_ORDER", param);
            DAL.close();
        ...
        public void DELETE_ORDER(string ID)
        {
            ...
            DAL.excutecommand("DELETE_ORDER", param);
            DAL.close();

        }

        public DataTable SEARCH_OPDER(string SEARCH)
        {
            DAL.DataAccessLayer DAL = new DAL.DataAccessLayer();
            DataTable Dt = new DataTable();
            SqlParameter[] param = new SqlParameter[1];
            ...
            Dt = DAL.selectdata("SEARCH_OPDER", param);
            DAL.close();
            return Dt;
        }
