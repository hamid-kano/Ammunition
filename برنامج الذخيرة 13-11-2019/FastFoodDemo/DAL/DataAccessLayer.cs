...
namespace FastFoodDemo.DAL
{
    class DataAccessLayer
    {
        ...
        {
            sqlconnection = new SqlConnection(@"Server = " + Program.SERVER_NAME + "; DataBase=SilahWarehouse; Integrated Security= false; USER ID =" + Program.userid + ";PASSWORD =" + Program.pass + "");
        }
